...
// Get editor profile
$profile = jasti_user_editor_profile($pdo, $user['user_id']);
if (!$profile) {
    jasti_json(['message' => 'You do not have an editor profile.'], 403);
}
...
jasti_json([
    ...
    'stats' => $stats,
    'access' => [
        'can_view_submissions' => jasti_can_access_dashboard($pdo, $user['user_id'], 'submissions'),
        'can_edit_submissions' => jasti_can_edit_dashboard($pdo, $user['user_id'], 'submissions'),
        'can_view_reviewers' => jasti_can_access_dashboard($pdo, $user['user_id'], 'reviewers'),
        'can_edit_reviewers' => jasti_can_edit_dashboard($pdo, $user['user_id'], 'reviewers'),
        'can_view_decisions' => jasti_can_access_dashboard($pdo, $user['user_id'], 'decisions'),
        'can_edit_decisions' => jasti_can_edit_dashboard($pdo, $user['user_id'], 'decisions'),
        'can_view_formatting' => jasti_can_access_dashboard($pdo, $user['user_id'], 'formatting'),
    ],
]);
