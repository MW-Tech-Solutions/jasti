...
if (!$isAdmin && !$isEIC) {
    jasti_json(['message' => 'Unauthorized. Only admin or editor-in-chief can reject reviewer applications.'], 403);
}
...
jasti_json(['message' => 'Reviewer application rejected.', 'reviewer_id' => $reviewerId], 200);
