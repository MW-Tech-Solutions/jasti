...
export const fallbackJournalSettings: JournalSettings = {
  ...
  submission_fee_ngn: "10000",
  publication_fee_ngn: "50000",
}
...
export function normalizeJournalSettings(candidate: unknown): JournalSettings {
  ...
  return {
    ...
    whatsapp_number: readString(source, "whatsapp_number", fallbackJournalSettings.whatsapp_number),
    default_gq_percent: readString(source, "default_gq_percent", fallbackJournalSettings.default_gq_percent),
    default_ai_score_percent: readString(source, "default_ai_score_percent", fallbackJournalSettings.default_ai_score_percent),
    default_similarity_percent: readString(source, "default_similarity_percent", fallbackJournalSettings.default_similarity_percent),
    submission_fee_ngn: readString(source, "submission_fee_ngn", fallbackJournalSettings.submission_fee_ngn),
    publication_fee_ngn: readString(source, "publication_fee_ngn", fallbackJournalSettings.publication_fee_ngn),
  }
}
