...
1. Edit [api/support/config.php](/opt/lampp/htdocs/ajasti/api/support/config.php)
...
### 2. Upload these items to `public_html/ajasti` or your target web root
...
- For your current deployment path, use `public_html/ajasti`
