...
reg_url = 'http://localhost/ajasti/api/auth/register.php'
reg_data = json.dumps({
    'first_name': 'Jane',
    'last_name': 'Developer',
...
print("\n=== STEP 2: Login ===")
login_url = 'http://localhost/ajasti/api/auth/login.php'
...
dashboard_url = 'http://localhost/ajasti/api/editor/dashboard.php'
