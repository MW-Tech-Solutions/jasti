...
export const workspaceConfigs: WorkspaceRoleConfig[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        fields: ['Title', 'Abstract', 'Keywords', 'Author list and affiliations', 'Manuscript upload (PDF/Word/Latex)', 'Supplementary files: datasets, code, figures'],
      },
      // {
      //   id: 'compliance',
      ...
      //   description: 'Central inbox for reviewer comments, editor messages, and decision letters.',
      //   checklist: ['Messages from editors', 'Review comments', 'Decision letters'],
      // },
      {
        id: 'metrics',
  ...
  },
  {
    ...
    sections: [
      ...
      {
        id: 'assignments',
        label: 'Manuscript Assignment Panel',
        description: 'Track items waiting for handling, in review, or returned as revision.',
        checklist: ['New submissions waiting for handling', 'Manuscripts in review', 'Revisions submitted'],
      },
      {
        id: 'screening',
        label: 'Initial Screening',
        description: 'Run scope, format, and ethics checks before reviewer invitation.',
        checklist: ['Scope check', 'Formatting compliance', 'Ethical screening', 'Plagiarism report'],
      },
      {
        id: 'selection',
